...
Definition NEW : nat :=
  1120.
Program Definition new_ (rows_1118 : dim_type_t) (cols_1119 : dim_type_t) (
    seq_1117 : seq scalar_t)
  : both (fset.fset0) [interface] (mat_res_t) :=
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        if is_pure (I := [interface]) (((seq_len (lift_to_both0 seq_1117)) >.? (
              lift_to_both0 (usize 0))) && (((lift_to_both0 rows_1118) .* (
                lift_to_both0 cols_1119)) =.? (seq_len (
...
Definition REPEAT : nat :=
  1127.
Program Definition repeat (n_1123 : dim_type_t) (m_1124 : dim_type_t) (
    scalar_1126 : scalar_t)
  : both (CEfset ([ret_1121_loc])) [interface] (matrix_t) :=
  ((letbm ret_1121 : seq int128 loc( ret_1121_loc ) :=
      ...
      letb ret_1121 :=
        foldi_both' (lift_to_both0 (usize 0)) ((lift_to_both0 n_1123) .* (
              lift_to_both0 m_1124)) ret_1121 (L := (CEfset ([ret_1121_loc]))) (
            I := [interface]) (fun i_1125 ret_1121 =>
...
Definition ZEROS : nat :=
  1130.
Program Definition zeros (n_1128 : dim_type_t) (m_1129 : dim_type_t)
  : both (CEfset ([ret_1121_loc])) [interface] (matrix_t) :=
...
Definition ONES : nat :=
  1133.
Program Definition ones (n_1131 : dim_type_t) (m_1132 : dim_type_t)
  : both (CEfset ([ret_1121_loc])) [interface] (matrix_t) :=
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (repeat (
...
Definition IDENTITY : nat :=
  1140.
Program Definition identity (n_1136 : dim_type_t) (m_1137 : dim_type_t)
  : both (CEfset ([ret_1134_loc])) [interface] (matrix_t) :=
  ((letbm ret_1134 : seq int128 loc( ret_1134_loc ) :=
      ...
      letb ret_1134 :=
        foldi_both' (lift_to_both0 (usize 0)) (min (lift_to_both0 n_1136) (
              lift_to_both0 m_1137)) ret_1134 (L := (CEfset ([ret_1134_loc]))) (
            I := [interface]) (fun i_1138 ret_1134 =>
...
Definition INDEX : nat :=
  1149.
Program Definition index (m_1141 : matrix_t) (i_1146 : dim_type_t) (
    j_1147 : dim_type_t)
...
Definition TRANSPOSE : nat :=
  1161.
Program Definition transpose (matrix_1152 : matrix_t)
  : both (CEfset ([ret_1150_loc])) [interface] (matrix_t) :=
  ((letb '(dim_1153, seq_1154) : (dims_t '× seq scalar_t) :=
      ...
      letb ret_1150 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 rows_1155) ret_1150 (L := (CEfset ([ret_1150_loc]))) (
            I := [interface]) (fun i_1157 ret_1150 =>
            letb ret_1150 :=
              foldi_both' (lift_to_both0 (usize 0)) (
...
Definition SLICE : nat :=
  1182.
Program Definition slice (matrix_1166 : matrix_t) (start_1171 : dims_t) (
    len_1174 : dims_t)
  : both (CEfset ([ret_1162_loc ; res_1163_loc])) [interface] (mat_res_t) :=
  ((letb '(dim_1167, seq_1168) : (dims_t '× seq scalar_t) :=
      ...
      letb '(ret_1162, res_1163) :=
        ...
        then lift_scope (L1 := CEfset ([ret_1162_loc ; res_1163_loc])) (
          L2 := CEfset ([ret_1162_loc ; res_1163_loc])) (I1 := [interface]) (
                ...
                letb ret_1162 :=
                  foldi_both' (lift_to_both0 (usize 0)) (
                      ...
                      letb ret_1162 : seq int128 :=
                        seq_upd ret_1162 (lift_to_both0 ret_index_1180) (
                          is_pure (seq_index (seq_1168) (
         ...
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (lift_to_both0 res_1163)
...
Definition SCALE : nat :=
  1190.
Program Definition scale (matrix_1185 : matrix_t) (scalar_1189 : scalar_t)
      ...
      letb ret_1183 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 seq_1187)) ret_1183 (L := (CEfset (
                [ret_1183_loc]))) (I := [interface]) (fun i_1188 ret_1183 =>
...
Definition ADD : nat :=
  1202.
Program Definition add (matrix_1_1195 : matrix_t) (matrix_2_1198 : matrix_t)
  : both (CEfset ([ret_1191_loc ; res_1192_loc])) [interface] (mat_res_t) :=
  ((letb '(m1_dim_1196, m1_s_1197) : (dims_t '× seq scalar_t) :=
      ...
      letb '(ret_1191, res_1192) :=
        ...
        then lift_scope (L1 := CEfset ([ret_1191_loc ; res_1192_loc])) (
          L2 := CEfset ([ret_1191_loc ; res_1192_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1191 :=
            foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                  lift_to_both0 m1_s_1197)) ret_1191 (L := (CEfset (
                    [ret_1191_loc ; res_1192_loc]))) (I := [interface]) (
                fun i_1201 ret_1191 =>
         ...
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (lift_to_both0 res_1192)
...
Definition SUB : nat :=
  1214.
Program Definition sub (matrix_1_1207 : matrix_t) (matrix_2_1210 : matrix_t)
  : both (CEfset ([ret_1203_loc ; res_1204_loc])) [interface] (mat_res_t) :=
  ((letb '(m1_dim_1208, m1_s_1209) : (dims_t '× seq scalar_t) :=
      ...
      letb '(ret_1203, res_1204) :=
        ...
        then lift_scope (L1 := CEfset ([ret_1203_loc ; res_1204_loc])) (
          L2 := CEfset ([ret_1203_loc ; res_1204_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1203 :=
            foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                  lift_to_both0 m1_s_1209)) ret_1203 (L := (CEfset (
                    [ret_1203_loc ; res_1204_loc]))) (I := [interface]) (
                fun i_1213 ret_1203 =>
         ...
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (lift_to_both0 res_1204)
...
Definition COMPONENT_MUL : nat :=
  1226.
Program Definition component_mul (matrix_1_1219 : matrix_t) (
    matrix_2_1222 : matrix_t)
  : both (CEfset ([ret_1215_loc ; res_1216_loc])) [interface] (mat_res_t) :=
  ((letb '(m1_dim_1220, m1_s_1221) : (dims_t '× seq scalar_t) :=
      ...
      letb '(ret_1215, res_1216) :=
        ...
        then lift_scope (L1 := CEfset ([ret_1215_loc ; res_1216_loc])) (
          L2 := CEfset ([ret_1215_loc ; res_1216_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1215 :=
            foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                  lift_to_both0 m1_s_1221)) ret_1215 (L := (CEfset (
                    [ret_1215_loc ; res_1216_loc]))) (I := [interface]) (
                fun i_1225 ret_1215 =>
         ...
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (lift_to_both0 res_1216)
...
Definition MUL : nat :=
  1249.
Program Definition mul (matrix_1_1233 : matrix_t) (matrix_2_1236 : matrix_t)
  : both (CEfset ([ret_1227_loc ; res_1228_loc ; acc_1229_loc])) [interface] (
    mat_res_t) :=
  ((letb '(dim_1_1234, seq_1_1235) : (dims_t '× seq scalar_t) :=
      ...
      letb '(ret_1227, res_1228) :=
        ...
        then lift_scope (L1 := CEfset (
          ...
          letb ret_1227 :=
            foldi_both' (lift_to_both0 (usize 0)) (
                lift_to_both0 l_1239) ret_1227 (L := (CEfset (
                    [ret_1227_loc ; res_1228_loc ; acc_1229_loc]))) (
                I := [interface]) (fun i_1243 ret_1227 =>
                letb ret_1227 :=
                  foldi_both' (lift_to_both0 (usize 0)) (
                      lift_to_both0 n_1242) ret_1227 (L := (CEfset (
                          [ret_1227_loc ; res_1228_loc ; acc_1229_loc]))) (
                      I := [interface]) (fun j_1244 ret_1227 =>
                      ...
                      letb acc_1229 :=
                        foldi_both' (lift_to_both0 (usize 0)) (
                            lift_to_both0 m_1240) acc_1229 (L := (CEfset (
                                [ret_1227_loc ; res_1228_loc ; acc_1229_loc]))) (
                            I := [interface]) (fun k_1246 acc_1229 =>
                            ...
                            letbm acc_1229 loc( acc_1229_loc ) :=
                              (lift_to_both0 acc_1229) .+ ((seq_index (
                                    seq_1_1235) (
                                    lift_to_both0 index_1_1247)) .* (seq_index (
                                    seq_2_1238) (
                                    lift_to_both0 index_2_1248))) in
                            lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
         ...
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (lift_to_both0 res_1228)
      ) : both (CEfset (
        [ret_1227_loc ; res_1228_loc ; acc_1229_loc])) [interface] (mat_res_t)).
Fail Next Obligation.
